...
### Added
- Added `Page()` method to router `Group` for fluent page registration API
- Added `GroupPageBuilder` for building pages within route groups

### Fixed
- Fixed missing `Page()` method in router groups that broke example compilation
...
[Unreleased]: https://github.com/xraph/forgeui/compare/v0.0.3...HEAD
[0.0.3]: https://github.com/xraph/forgeui/compare/v0.0.2...v0.0.3
